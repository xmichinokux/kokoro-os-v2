...
function buildGeneratePrompt(keyword: string, aestheticMap: string): string {
  return `あなたは音楽・映画・本・漫画・アニメ・ゲームなどあらゆるジャンルのカルチャーに精通した専門家です。
...
【タスク】
入力キーワードを起点に、関連するおすすめのカルチャー（音楽、映画、本、漫画、アニメ、ゲームなど）をファミリーツリー形式で提案してください。
...
・実在する作品・アーティスト・バンド・映画・本のみ推薦すること
・各ノードには「名前」「ジャンル」「一言説明（20文字以内、なぜおすすめか）」を含める
・ジャンルは music, movie, book, manga, anime, game, other のいずれか
...
${aestheticMap ? `【ユーザーの感性マップ】\n${aestheticMap}\n` : ''}
【タスク】
「${keyword}」を起点に、関連するおすすめをさらに3世代のファミリーツリーで提案してください。
